...
const lexer_info rust_info = {
    "rust", "Rust", {aliases}, {filenames}, {mimes}, "https://www.rust-lang.org", 10,
};
} // namespace
...
state_map rust_lexer::get_rules() const {
    ...
    rules["root"] = {
        ...
        {R"(\b(bool|char|f32|f64|i8|i16|i32|i64|i128|isize|str|u8|u16|u32|u64|u128|usize)\b)", tk::keyword::type,
         state_action::none()},
        {R"(\b(Box|Option|Result|String|Vec|HashMap|HashSet|Rc|Arc|Cell|RefCell|Mutex|Some|None|Ok|Err)\b)",
        ...
        {R"([0-9][0-9_]*(u8|u16|u32|u64|u128|usize|i8|i16|i32|i64|i128|isize)?)", tk::literal::number::integer,
         state_action::none()},
