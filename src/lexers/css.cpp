...
state_map css_lexer::get_rules() const {
    ...
    rules["root"] = {
        ...
        {.pattern = R"(/\*)",
         ...
         .group_tokens = {}},
        {.pattern = R"(@[a-zA-Z-]+)", .token = tk::keyword::self, .action = state_action::none(), .group_tokens = {}},
        {.pattern = R"(\.[a-zA-Z_][\w-]*)",
        ...
        {.pattern = R"(::[a-zA-Z-]+)",
         ...
         .action = state_action::none(),
         .group_tokens = {}},
        {.pattern = R"(:[a-zA-Z-]+)", .token = tk::name::decorator, .action = state_action::none(), .group_tokens = {}},
        {.pattern =
         ...
         .action = state_action::none(),
         .group_tokens = {}},
        {.pattern = R"(!important)", .token = tk::keyword::self, .action = state_action::none(), .group_tokens = {}},
        {.pattern =
