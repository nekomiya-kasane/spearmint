...
#define SM_FG(color)        style_rule{color, 0, false, false, false, false, false, false, false, true, false}
#define SM_BG(color)        style_rule{0, color, false, false, false, false, false, false, false, false, true}
#define SM_FGBG(f, b)       style_rule{f, b, false, false, false, false, false, false, false, true, true}
#define SM_BOLD(color)      style_rule{color, 0, true, false, false, false, false, false, false, true, false}
#define SM_ITALIC(color)    style_rule{color, 0, false, true, false, false, false, false, false, true, false}
#define SM_BOLDITALIC(c)    style_rule{c, 0, true, true, false, false, false, false, false, true, false}
#define SM_UL(color)        style_rule{color, 0, false, false, true, false, false, false, false, true, false}
#define SM_BOLDUL(color)    style_rule{color, 0, true, false, true, false, false, false, false, true, false}
#define SM_PLAIN_BOLD       style_rule{0, 0, true, false, false, false, false, false, false, false, false}
#define SM_PLAIN_ITALIC     style_rule{0, 0, false, true, false, false, false, false, false, false, false}
#define SM_PLAIN_UL         style_rule{0, 0, false, false, true, false, false, false, false, false, false}
#define SM_PLAIN_NOBOLD     style_rule{0, 0, false, false, false, false, true, false, false, false, false}
...
inline constexpr static_style_def<24> monokai = {
    "monokai", "Monokai",
    0x272822, true,
    0x49483e, true,
    0x8f908a, 0x49483e,
...
inline constexpr static_style_def<30> default_ = {
    "default", "Default",
    0xf8f8f8, true,
    0xffffcc, true,
    0x666666, 0,
...
inline constexpr static_style_def<22> dracula = {
    "dracula", "Dracula",
    0x282a36, true,
    0x44475a, true,
    0x6272a4, 0,
...
inline constexpr static_style_def<22> nord = {
    "nord", "Nord",
    0x2e3440, true,
    0x434c5e, true,
    0x616e88, 0,
...
inline constexpr static_style_def<22> one_dark = {
    "one-dark", "One Dark",
    0x282c34, true,
    0x3e4451, true,
    0x636d83, 0,
...
inline constexpr static_style_def<22> solarized_dark = {
...
inline constexpr static_style_def<22> solarized_light = {
...
inline constexpr static_style_def<22> gruvbox_dark = {
...
inline constexpr static_style_def<22> vim = {
    "vim", "Vim",
    0x000000, true,
    0x222222, true,
    0x808080, 0,
...
inline constexpr static_style_def<22> github_dark = {
...
inline constexpr static_style_def<26> emacs = {
    "emacs", "Emacs",
    0xf8f8f8, true,
    0xffffcc, true,
    0x666666, 0,
...
inline constexpr static_style_def<26> friendly = {
    "friendly", "Friendly",
    0xf0f0f0, true,
    0xffffcc, true,
    0x666666, 0,
...
inline constexpr static_style_def<22> native = {
    "native", "Native",
    0x202020, true,
    0x404040, true,
    0xaaaaaa, 0,
...
inline constexpr static_style_def<20> zenburn = {
    "zenburn", "Zenburn",
    0x3f3f3f, true,
    0x484848, true,
    0x5d6262, 0,
...
inline constexpr static_style_def<10> bw = {
    "bw", "Black & White",
    0xffffff, true,
    0xeeeeee, true,
    0x666666, 0,
