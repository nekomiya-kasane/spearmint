...
namespace spearmint {
    ...
    namespace token {
        ...
        inline constexpr token_type whitespace{detail::id_whitespace, detail::id_text, "Token.Text.Whitespace",
                                               "Whitespace"};
        ...
        namespace keyword {
            ...
            inline constexpr token_type constant{detail::id_keyword_constant, detail::id_keyword,
                                                 "Token.Keyword.Constant", "Constant"};
            inline constexpr token_type declaration{detail::id_keyword_declaration, detail::id_keyword,
                                                    "Token.Keyword.Declaration", "Declaration"};
            inline constexpr token_type namespace_{detail::id_keyword_namespace, detail::id_keyword,
                                                   "Token.Keyword.Namespace", "Namespace"};
            inline constexpr token_type pseudo{detail::id_keyword_pseudo, detail::id_keyword, "Token.Keyword.Pseudo",
                                               "Pseudo"};
            inline constexpr token_type reserved{detail::id_keyword_reserved, detail::id_keyword,
                                                 "Token.Keyword.Reserved", "Reserved"};
        ...
        namespace name {
            ...
            inline constexpr token_type attribute{detail::id_name_attribute, detail::id_name, "Token.Name.Attribute",
                                                  "Attribute"};
            inline constexpr token_type builtin{detail::id_name_builtin, detail::id_name, "Token.Name.Builtin",
                                                "Builtin"};
            inline constexpr token_type builtin_pseudo{detail::id_name_builtin_pseudo, detail::id_name,
            ...
            inline constexpr token_type constant{detail::id_name_constant, detail::id_name, "Token.Name.Constant",
                                                 "Constant"};
            inline constexpr token_type decorator{detail::id_name_decorator, detail::id_name, "Token.Name.Decorator",
                                                  "Decorator"};
            inline constexpr token_type entity{detail::id_name_entity, detail::id_name, "Token.Name.Entity", "Entity"};
            inline constexpr token_type exception{detail::id_name_exception, detail::id_name, "Token.Name.Exception",
                                                  "Exception"};
            inline constexpr token_type function{detail::id_name_function, detail::id_name, "Token.Name.Function",
                                                 "Function"};
            inline constexpr token_type function_magic{detail::id_name_function_magic, detail::id_name,
                                                       "Token.Name.Function.Magic", "Magic"};
            inline constexpr token_type label{detail::id_name_label, detail::id_name, "Token.Name.Label", "Label"};
            inline constexpr token_type namespace_{detail::id_name_namespace, detail::id_name, "Token.Name.Namespace",
                                                   "Namespace"};
            inline constexpr token_type other{detail::id_name_other, detail::id_name, "Token.Name.Other", "Other"};
            inline constexpr token_type property{detail::id_name_property, detail::id_name, "Token.Name.Property",
                                                 "Property"};
            inline constexpr token_type tag{detail::id_name_tag, detail::id_name, "Token.Name.Tag", "Tag"};
            inline constexpr token_type variable{detail::id_name_variable, detail::id_name, "Token.Name.Variable",
                                                 "Variable"};
        ...
        namespace literal {
            ...
            // String
            namespace string {
                inline constexpr token_type self{detail::id_string, detail::id_literal, "Token.Literal.String",
                                                 "String"};
                inline constexpr token_type affix{detail::id_string_affix, detail::id_string,
                                                  "Token.Literal.String.Affix", "Affix"};
                inline constexpr token_type backtick{detail::id_string_backtick, detail::id_string,
                                                     "Token.Literal.String.Backtick", "Backtick"};
                inline constexpr token_type char_{detail::id_string_char, detail::id_string,
                                                  "Token.Literal.String.Char", "Char"};
                inline constexpr token_type delimiter{detail::id_string_delimiter, detail::id_string,
                                                      "Token.Literal.String.Delimiter", "Delimiter"};
                inline constexpr token_type doc{detail::id_string_doc, detail::id_string, "Token.Literal.String.Doc",
                                                "Doc"};
                inline constexpr token_type double_{detail::id_string_double, detail::id_string,
                                                    "Token.Literal.String.Double", "Double"};
                inline constexpr token_type escape{detail::id_string_escape, detail::id_string,
                                                   "Token.Literal.String.Escape", "Escape"};
                inline constexpr token_type heredoc{detail::id_string_heredoc, detail::id_string,
                                                    "Token.Literal.String.Heredoc", "Heredoc"};
                inline constexpr token_type interpol{detail::id_string_interpol, detail::id_string,
                                                     "Token.Literal.String.Interpol", "Interpol"};
                inline constexpr token_type other{detail::id_string_other, detail::id_string,
                                                  "Token.Literal.String.Other", "Other"};
                inline constexpr token_type regex{detail::id_string_regex, detail::id_string,
                                                  "Token.Literal.String.Regex", "Regex"};
                inline constexpr token_type single{detail::id_string_single, detail::id_string,
                                                   "Token.Literal.String.Single", "Single"};
                inline constexpr token_type symbol{detail::id_string_symbol, detail::id_string,
                                                   "Token.Literal.String.Symbol", "Symbol"};
            } // namespace string

            // Number
            namespace number {
                inline constexpr token_type self{detail::id_number, detail::id_literal, "Token.Literal.Number",
                                                 "Number"};
                inline constexpr token_type bin{detail::id_number_bin, detail::id_number, "Token.Literal.Number.Bin",
                                                "Bin"};
                inline constexpr token_type float_{detail::id_number_float, detail::id_number,
                                                   "Token.Literal.Number.Float", "Float"};
                inline constexpr token_type hex{detail::id_number_hex, detail::id_number, "Token.Literal.Number.Hex",
                                                "Hex"};
                inline constexpr token_type integer{detail::id_number_integer, detail::id_number,
                                                    "Token.Literal.Number.Integer", "Integer"};
                ...
                inline constexpr token_type oct{detail::id_number_oct, detail::id_number, "Token.Literal.Number.Oct",
                                                "Oct"};
            } // namespace number
        } // namespace literal
        ...
        namespace operator_ {
            ...
            inline constexpr token_type word{detail::id_operator_word, detail::id_operator, "Token.Operator.Word",
                                             "Word"};
        } // namespace operator_

        // Punctuation
        namespace punctuation {
            inline constexpr token_type self{detail::id_punctuation, detail::id_root, "Token.Punctuation",
                                             "Punctuation"};
            inline constexpr token_type marker{detail::id_punctuation_marker, detail::id_punctuation,
                                               "Token.Punctuation.Marker", "Marker"};
        } // namespace punctuation

        // Comment
        namespace comment {
            inline constexpr token_type self{detail::id_comment, detail::id_root, "Token.Comment", "Comment"};
            inline constexpr token_type hashbang{detail::id_comment_hashbang, detail::id_comment,
                                                 "Token.Comment.Hashbang", "Hashbang"};
            inline constexpr token_type multiline{detail::id_comment_multiline, detail::id_comment,
                                                  "Token.Comment.Multiline", "Multiline"};
            inline constexpr token_type preproc{detail::id_comment_preproc, detail::id_comment, "Token.Comment.Preproc",
                                                "Preproc"};
            ...
            inline constexpr token_type single{detail::id_comment_single, detail::id_comment, "Token.Comment.Single",
                                               "Single"};
            inline constexpr token_type special{detail::id_comment_special, detail::id_comment, "Token.Comment.Special",
                                                "Special"};
        } // namespace comment
        ...
        namespace generic {
            ...
            inline constexpr token_type deleted{detail::id_generic_deleted, detail::id_generic, "Token.Generic.Deleted",
                                                "Deleted"};
            inline constexpr token_type emph{detail::id_generic_emph, detail::id_generic, "Token.Generic.Emph", "Emph"};
            inline constexpr token_type error{detail::id_generic_error, detail::id_generic, "Token.Generic.Error",
                                              "Error"};
            inline constexpr token_type heading{detail::id_generic_heading, detail::id_generic, "Token.Generic.Heading",
                                                "Heading"};
            inline constexpr token_type inserted{detail::id_generic_inserted, detail::id_generic,
                                                 "Token.Generic.Inserted", "Inserted"};
            inline constexpr token_type output{detail::id_generic_output, detail::id_generic, "Token.Generic.Output",
                                               "Output"};
            inline constexpr token_type prompt{detail::id_generic_prompt, detail::id_generic, "Token.Generic.Prompt",
                                               "Prompt"};
            inline constexpr token_type strong{detail::id_generic_strong, detail::id_generic, "Token.Generic.Strong",
                                               "Strong"};
            inline constexpr token_type strong_emph{detail::id_generic_strong_emph, detail::id_generic,
                                                    "Token.Generic.StrongEmph", "StrongEmph"};
            inline constexpr token_type subheading{detail::id_generic_subheading, detail::id_generic,
                                                   "Token.Generic.Subheading", "Subheading"};
            inline constexpr token_type traceback{detail::id_generic_traceback, detail::id_generic,
                                                  "Token.Generic.Traceback", "Traceback"};
        } // namespace generic
